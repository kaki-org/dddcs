namespace SnsDomain.Models.Circles
{
    public class CircleName : IEquatable<CircleName>
    {
        public CircleName(string value)
        {
            ...
            if (value.Length < 3) throw new ArgumentNullException("サークル名は3文字以上です", nameof(value));
            if (value.Length > 20) throw new ArgumentNullException("サークル名は20文字以下です", nameof(value));
